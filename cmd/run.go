...
func init() {
	...
	runCmd.Flags().StringVar(&amqpUri, "amqpUri", "amqp://guest:guest@service-rabbitmq:5672/", "The RabbitMQ cluster connection URI")
	...
	runCmd.Flags().StringVar(&apiUri, "apiUri", "http://service-rabbitmq:15672/api/", "The RabbitMQ management gateway URI")
